...
<spr:form action="${pageContext.request.contextPath}/cv/updateEducation"
	...
	<div class="modal-body">
		...
		<p style="font-style: oblique; margin-top: -5px; margin-left: 20px;">
			<s:message code="education_unv_name"></s:message>
		</p>
		<p>
		<p>
		...
		<p
			style="float: left; margin-top: -143px; margin-left: 59%; font-style: oblique;">
		...
		<p
			style="float: left; margin-top: -75px; margin-left: 59%; font-style: oblique;">
