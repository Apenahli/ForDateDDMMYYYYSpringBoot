...
<body
		...
		<div class="content-left">
			...
			<div style="color: white; margin-left: 20px; margin-top: 20px">
				...
				<div class="color" id="edit_Skill_div">
					<p style="margin-bottom: 8px;">
						<a style="text-decoration: none; color: #E1E9EE;"
							href="javascript:getInsertForm(${employee.id})"><s:message
								code="top_skill"></s:message> </a>
								
								
							<a
							href="javascript:getInsertForm(${employee.id})"
				...
				<div class="skills">
					...
					href="javascript:getEditSkill(${skill.id},${employee.id})">${skill.name}</a>
				
					<a href="javascript:getEditSkill(${skill.id},${employee.id})"
					id="edit_Skill_a2" style="font-size: 12px; color: white;" hidden> 
				...
				<div class="color" id="edit_Languages_div">
					<p style="margin-bottom: 8px;">
						<a style="text-decoration: none; color: #E1E9EE;"
							href="javascript:getInsertLanguage(${employee.id})"> <s:message
								code="language"></s:message></a>
								
									<a
							href="javascript:getInsertLanguage(${employee.id})"
						...
						<div id="edit_Languages_div2">
							...
							<p style="margin-bottom: 5px;">
								<a style="color: white; text-decoration: none;"
									href="javascript:editLanguage(${language.id},${employee.id})">
									${language.name} </a>
				...
				<div class="color" id="edit_Certificate_div">
					<p style="margin-bottom: 8px;">
						<a style="text-decoration: none; color: #E1E9EE;"
							href="javascript:getInsertCertificate(${employee.id})"> <s:message
								code="certificate"></s:message></a> 
								
								<a
							href="javascript:getInsertCertificate(${employee.id})"
					...
					<c:forEach var="certificate" items="${employee.certificates}">
						...
						<div id="edit_Certificate_div2">
							<p style="margin-bottom: 5px;">
								...
								<a style="text-decoration: none; color: white"
									href="javascript:getEditCertificate('${certificate.id}',${employee.id})">
	...
	<div class="content-right">
		...
		<div class="class4">
			...
			<div class="class5" style="font-weight: normal;"
				id="edit_Summary_div">

				<a style="text-decoration: none; color: black"
					href="javascript:getInsertSummary('${employee.id}')"> <s:message
						code="summary"></s:message>
				</a> <a href="javascript:getInsertSummary('${employee.id}')"
				...
				<c:forEach var="summary" items="${employee.details}">
					<div id="edit_Summary_div2">
						<p style="margin-top: 7px;">
							<a style="text-decoration: none; color: black"
								href="javascript:getEditSummary('${summary.id}')">
								${summary.name} </a>
			...
			<div class="class5" id="edit_Experie_div"
				style="font-weight: normal;">
				<a style="text-decoration: none; color: black"
					href="javascript:getInserExperience('${employee.id}')"> <s:message
						code="experience"></s:message>

				</a>
				
				 <a href="javascript:getInserExperience('${employee.id}')"
			...
			<c:forEach var="experience" items="${employee.experience}">
				...
				<div id="edit_Experie_div2">
					...
					<a style="text-decoration: none; color: black"
						href="javascript:getEditExperience('${experience.id}')">
			...
			<div class="class5" style="font-weight: normal;"
				id="edit_Education_div">

				<a style="text-decoration: none; color: black"
					href="javascript:getInserEducation('${employee.id}')"> <s:message
						code="education"></s:message></a> 
						
						<a
					href="javascript:getInserEducation('${employee.id}')"
			...
			<c:forEach var="education" items="${employee.education}">
				<div id="edit_Education_div2">
					<p>
						<a style="text-decoration: none; color: black"
							href="javascript:getEditEducation('${education.id}')">${education.universityName}
						</a> <a href="javascript:getEditExperience('${experience.id}')"
					...
					<p>
						<a style="text-decoration: none; color: black"
							href="javascript:getEditEducation('${education.id}')">${education.speciality}</a>
					</p>
					<p>
						<a style="text-decoration: none; color: black"
							href="javascript:getEditEducation('${education.id}')">${education.faculty}</a>
					</p>
					<p>
						<a style="text-decoration: none; color: black"
							href="javascript:getEditEducation('${education.id}')">${education.degree}(${education.startTime}/
							${education.endTime} )</a>
					</p>
