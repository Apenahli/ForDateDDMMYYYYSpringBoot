...
<body>
	...
	<div class="container">
		...
		<c:if test="${not empty exp}">
			<h4 style="color: red;">
				<s:message code="dempartment_deleted"></s:message>
			</h4>
			<br>
		</c:if>

		<a href="javascript:getInsertForm()" class="btn btn-primary color"
		...
		<table class="table table-hover table-bordered">
			<tr>
				<th scope="col"><s:message code="DepName"></s:message></th>
				<th scope="col"></th>
			</tr>
