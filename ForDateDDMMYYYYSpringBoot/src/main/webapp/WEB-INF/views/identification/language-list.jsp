...
<body>
	...
	<div class="container">
		...
		<c:if test="${not empty exp}">
			<h4 style="color: red;">
				<s:message code="language_deleted"></s:message>
			</h4>
		</c:if>


		<a href="javascript:getInsertLangForm()" class="btn btn-primary color"
			style="background-color: #4A696F"><s:message code="insert"></s:message></a>
		<br> <br>

		<table class="table table-hover table-bordered">
			<tr>
				<th scope="col"><s:message code="language_name"></s:message></th>
				<th scope="col"></th>
			</tr>
			...
			<c:forEach var="language" items="${languages}">
				<tr>
					<td>${language.name}</td>
					<td><a href="javascript:geteditLangform('${language.id}')"
						class="btn btn-primary color" style="background-color: #4A696F">
							<s:message code="edit"></s:message>
					</a> <a href="javascript:getDeleteLangForm('${language.id}')"
