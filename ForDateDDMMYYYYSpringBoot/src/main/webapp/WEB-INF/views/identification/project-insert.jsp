...
<spr:form action="${pageContext.request.contextPath}/projects/save"
	...
	<div class="modal-body">
		...
		<p style="margin-left: 5px;">	<s:message code="project_name"></s:message></p>
	...
	<div class="modal-footer">
		...
		<s:message code="cancel"></s:message></button>
