...
<body>
	...
	<div class="container">
		...
		<c:if test="${not empty exp}">
			<h4 style="color: red;">
				<s:message code="roles_deleted"></s:message>
			</h4>
		</c:if>

		<a href="javascript:getInsertRolFormm()" class="btn btn-primary color"
			style="background-color: #4A696F"><s:message code="insert"></s:message></a>
		<br> <br>

		<table class="table table-hover table-bordered">
			<tr>
				<th scope="col"><s:message code="role_name"></s:message></th>
				<th scope="col"></th>
			</tr>
			...
			<c:forEach var="role" items="${role}">
				<tr>
					<td>${role.name}</td>
					<td><a href="javascript:geteditRolform('${role.id}')"
						class="btn btn-primary color" style="background-color: #4A696F">
							<s:message code="edit"></s:message>
					</a> <a href="javascript:getDeleteRolForm('${role.id}')"
