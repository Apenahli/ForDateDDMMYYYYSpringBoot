...
<body>
	...
	<div class="container">
		...
		<c:if test="${not empty exp}">
			<h4 style="color: red;">
				<s:message code="skill_deleted"></s:message>
			</h4>
		</c:if>



		<a href="javascript:getInsertSkillForm()"
			class="btn btn-primary color" style="background-color: #4A696F"><s:message
				code="insert"></s:message></a> <br> <br>

		<table class="table table-hover table-bordered">
			<tr>
				<th scope="col"><s:message code="skill_name"></s:message></th>
				<th scope="col"></th>
			</tr>
			...
			<c:forEach var="skill" items="${skills}">
				<tr>
					<td>${skill.name}</td>
					<td><a href="javascript:geteditSkillform('${skill.id}')"
						class="btn btn-primary color" style="background-color: #4A696F"><s:message
								code="edit"></s:message></a> <a
						href="javascript:getDeleteSkillForm('${skill.id}')"
