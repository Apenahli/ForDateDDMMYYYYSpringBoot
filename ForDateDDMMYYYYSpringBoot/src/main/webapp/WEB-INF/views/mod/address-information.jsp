...
<br>
<div>
<p style="margin-left: 20px; font-size: 20px; margin-bottom: 10px;"><s:message code="Addresses"></s:message></p>



<table class="table" border="1" style="margin-left: 20px;width: 700px;">
<tr>
<td>
<s:message code="legal_address"></s:message>

</td>
<td>
<!-- Qeydiyyatda olduğu adres -->
${employee.address}
<a  href="javascript:legal_address('${employee.address}','${employee.id}')"> <i style="float: right;"
class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
</td>
</tr>
<tr>
<td>
<s:message code="actual_address"></s:message>
<!-- Halhazırda yaşadığı adres -->
</td>
<td>

${employee.actualAddress}
<a href="javascript:_actualAddress('${employee.actualAddress}','${employee.id}')"> <i style="float: right;"
class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
</td>
</tr>
