...
<spr:form
	action="${pageContext.request.contextPath}/empProjectRole/edit"
	method="post" modelAttribute="empProjectRole">
	...
	<div class="modal-body">
		...
		<spr:select path="employee.id" class="form-control">
			<spr:option value="0" label="--- Select employee ---" />
