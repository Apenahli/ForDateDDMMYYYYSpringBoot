...
<a href="#" id="langTagA" class="btn btn-primary" 
...
search</a>
	...
	<!-- <h5 style="float: right; margin-right: 655px; margin-top:-35px;">2019-2020</h5> -->
	...
	<th
		...
		<tr>
			...
			<a href="javascript:editVacation('${vacation.id}')" style="color:black;text-decoration: none;" id="edit_Skill_div2">
			${vacation.employee.name} ${vacation.employee.surname} ${vacation.employee.fatherName}
			</a>
			
			<a href="javascript:editVacation('${vacation.id}')" id="edit_Skill_a2" hidden> 
			<i class="fa fa-pencil-square-o" aria-hidden="true" style="margin-left:15px;"></i></a>
            ...
            <a href="javascript:editVacationEmp('${vacation.id}')">
             <i class="fa fa-pencil-square-o" aria-hidden="true" style="margin-left:15px;"></i> </a>
			
			
			 <a href="javascript:reviewVacationEmp('${vacation.id}')">
		...
		<a href="javascript:insertVacationEmp()">
