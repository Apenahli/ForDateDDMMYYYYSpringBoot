...
<spr:form action="${pageContext.request.contextPath}/vacation/updateVacation2"
	...
	<p style="position: absolute; left: 25px; top: 20px;font-style: oblique;">
		...
		<spr:select path="basic_vacation_day" id="basic_vacation_day" class="form-control"  style=" width:230px;margin-left:190px;float:left;">
