...
<spr:form action="${pageContext.request.contextPath}/vacation/insertEmp"
	...
	<div class="modal-body" >
		...
		<spr:select path="employee.id" class="form-control" style="width:230px;margin-left:190px;float:left;">

			<c:forEach var="employee" items="${employees}">

				<spr:option value="${employee.id}">
				
				<c:out value="${employee.name} ${employee.surname}  ${employee.fatherName}" />
		...
		<spr:input path="remainder" type="text" id="remainder" name="remainder" class="form-control" style="margin-top:10px;  width:230px;margin-left:190px;float:left;"/> 
		...
		<spr:select path="basic_vacation_day" id="basic_vacation_day" class="form-control" style="margin-top:10px; width:230px;margin-left:190px;float:left;">
			...
			<p style="position: absolute; left: 25px; top: 155px;font-style: oblique;">
     	Sosial Mezuniyyet :</p>
